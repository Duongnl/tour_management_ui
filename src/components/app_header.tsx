  ...
  return (
    <>
      <Navbar className="bg-body-tertiary header">
        <Navbar.Brand>
          <Button className="btn-sidebar" onClick={() => handleShowSidebar()}>
          ...
          <Dropdown>
            <Dropdown.Toggle className="btn-dropdown">
              ...
              <span className="user-name">
                {account?.employee.employee_name}
              </span>
            </Dropdown.Toggle>

            <Dropdown.Menu>
              <Dropdown.Item href="/management/profile">Cá nhân</Dropdown.Item>
              <Dropdown.Item href="/management/setting">Cài đặt</Dropdown.Item>
              <Dropdown.Divider />
